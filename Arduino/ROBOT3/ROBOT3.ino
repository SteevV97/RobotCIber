...
//MQTT
const char *mqtt_server = "192.168.43.15";
const int mqtt_port = 1883;
const char *mqtt_user = "";
const char *mqtt_pass = "";
const char *root_topic_subscribe = "Robot3/system";
const char *ultrasonicoIzq_topic_publish = "Robot3/UltrasonicoIzquierda";
const char *ultrasonicoDer_topic_publish = "Robot3/UltrasonicoDerecha";
const char *IR_topic_publish = "Robot3/IR";
